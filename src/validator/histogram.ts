...
export const histogramSchema = z
  .object({
    sources: z.array(
      z.object({
...
export type HistogramPayload = z.infer<typeof histogramSchema>

export const defaultSourceHistogramValues: HistogramPayload['sources'] = [
  {
    entity_id: '1',
    legend: 'Temperature',
    color: 'default',
...
export const defaultHistogramValues: HistogramPayload = {
  sources: defaultSourceHistogramValues,
  widget_info: {
