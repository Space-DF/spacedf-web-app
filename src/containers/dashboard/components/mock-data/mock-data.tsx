...
import { WidgetRenderer } from './utils'
...
export const MockData: React.FC<Props> = memo(
  ({ isEdit, widgets, onChangeWidgets, onDeleteSuccess, onEditWidget }) => {
    ...
    const widgetList = useDashboardStore(
      useShallow((state) => state.widgetList)
    )
